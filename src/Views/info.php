            ...
            <div class="inform">
                ...
                <fieldset>
                    ...
                    foreach ($groups as $cur_group) {
                        ?>
                        <legend><?= __(Utils::escape($cur_group['g_title'])) ?></legend>
                        <div class="infldset">
                            <table class="aligntop">
                                <tr>
                                    <th scope="row">Use private messaging</th>
                                    <td>
                                        <label class="conl"><input type="radio" name="use_pm_g<?=
                                            Utils::escape($cur_group['g_id']) ?>" value="1"
                                        <?php if ($cur_group['g_use_pm'] == 1):  echo ' checked="checked"'; endif ?>
                                                                   tabindex="39"/>&#160;<strong>Yes</strong></label>
                                        <label class="conl"><input type="radio" name="use_pm_g<?=
                                            Utils::escape($cur_group['g_id']) ?>" value="0" tabindex="40"
                                        <?php if ($cur_group['g_use_pm'] == 0):  echo ' checked="checked"'; endif
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="pm_limit_g<?=
                                        Utils::escape($cur_group['g_id']) ?>" size="5" maxlength="4"
