...
class PrivateMessages
{
    ...
    public function getUserFolders($uid)
    {
        ...
        foreach ($result as $inbox) {
            $output[(int)$inbox['id']] = ['name' => $inbox['name']];
        }
        return $output;
    }
...
//        return Router::redirect(Router::pathFor('infoPlugin', ['name' => 'private-messages']),
        return Router::redirect(Router::pathFor('infoPlugin', ['name' => 'pms']),
            __('Perms updated redirect'));
    }
}
