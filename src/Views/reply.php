...
?>
        ...
        <div id="postform" class="blockform">
            <h2><span><?= __('Reply', 'private_messages') ?><?= (isset($conv['subject']) ? ' "'.$conv['subject'].'"' : '')?></span></h2>
            <div class="box">
                <form id="post" method="post" action="" onsubmit="return process_form(this)">
                    ...
                    <p class="buttons"><input type="submit" name="submit" value="<?= __('Submit') ?>" tabindex="4" accesskey="s" /> <input type="submit" name="preview" value="<?= __('Preview') ?>" tabindex="5" accesskey="p" /> <a href="javascript:history.go(-1)"><?= __('Go back') ?></a></p>
                </form>
            </div>
        </div>
